% +---------------------------------------------------------------------------+
% | content/english/chap/JapaneseWritingSystem.tex                            |
% |                                                                           |
% | Describe the Japanese writing system: Kanji, Kana (Katakana, Hiragana).   |
% |                                                                           |
% | Version: 0.1.0                                                            |
% |                                                                           |
% | Changes:                                                                  |
...
% |     - First version release (change section, input path)                  |
% |                                                                           |
% +---------------------------------------------------------------------------+
...
\section{Roman/ Latin/ Indian-Arabic Characters}
\input{\jpparal/Romaji}
