% +---------------------------------------------------------------------------+
% | content/english/sec/Iteration.tex                                         |
% |                                                                           |
% | Iteration Marks                                                           |
% |   - Double a Vowel                                                        |
% |   - Double a Character                                                    |
...
% | Changes:                                                                  |
% |                                                                           |
% | 0.1.0 2024-04-06 Christian Külker <c@c8i.org>                             |
% |     - Initial versioned release (add \jterm)                              |
% |                                                                           |
% +---------------------------------------------------------------------------+

\section{Iteration Marks}\jsec{繰り返し記号}\jterm{Iteration Marks}
% [o] LABEL
\label{sec:Iteration}
