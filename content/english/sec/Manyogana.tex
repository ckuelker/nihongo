...
\footnotesize By the end of the 8th Century 970 \hyperref[sec:Kanji]{{漢字}
{【かんじ】}} where used to pronounce the 90 \hyperref[sec:Mora]{morae}. This
directly shows that there was no bijective map between sound and character. For
\jtl{ka} for example the following \textbf{Man'yōgana} can be used
\jquotesingleja{可}, \jquotesingleja{何}, \jquotesingleja{加},
\jquotesingleja{架}, \jquotesingleja{香}, \jquotesingleja{蚊},
\jquotesingleja{迦}.
