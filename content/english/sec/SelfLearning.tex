...
The %
%
\jhiraganaonly{\hyperref[chap:HiraganaTraining]{third chapter}
(\nameref{chap:HiraganaTraining})} %
\jkatakanaonly{\hyperref[chap:KatakanaTraining]{third chapter}
(\nameref{chap:KatakanaTraining})} %
%
...
written in different fonts in the \nameref{chap:KanaTables} part starting at
