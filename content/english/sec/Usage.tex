...
\begin{itemize}
    ...
    \item[\Large\jhatsuon{\ldots}]
        ...
        \Info{\textbf{Japanese} reading:}{

          \begin{center} 

                  \Large Kanji {漢字} \jhiraganaonly{\jhatsuon{かんじ}}
                  \jkatakanaonly{\jhatsuon{カンジ}}
...
%        and transcription delimiters}.
         ...
         \Info{\textbf{Transcription}:}{

        \begin{center}

           The first \jtopic{} letter \Large \jhiraganaonly{{あ}}
           \jkatakanaonly{{ア}} \normalsize is transcibed as \Large {\jtl{a}}
           \normalsize in the Hepburn system.
...
%       {\tiny\Link\textit{Source: \url{https://en.wikipedia.org/wiki/N_(kana)}}}
    ...
    \item[\Large\jquotesingleja{\ldots}]
            ...
            \Info{Japanese \textbf{quotation} marks:}{

              The Japanese hiragana \Large \jquotesingleja{あ} \normalsize is
              written \jquotesingle{a} in the Hepburn system and transcribed as
              \jtl{a} to indicate that the Hepburn system was used.
    ...
    \item[\Large{\jpitch[br]{{X}}\jpitch[lt]{{Y}}}]
            ...
            \Info{Red \textbf{intonation} line example:}{

              High and then low in katakana {\jpitch[tr]{{ア}}\jpitch[lb]{メ}},
              low and then high in hiragana {\jpitch[br]{あ}\jpitch[lt]{め}}
              and as a transcription high and low
