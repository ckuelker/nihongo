\documentclass[makeidx=yes,draft=yes,version=last,paper=a4,headings=small,titlepage,makeidx,fontsize=12pt]{scrbook} 
...
\input{../share/chap/Introduction}          % Introduction
\input{../share/chap/JapaneseWritingSystem} % Japanese Writing Japanese
\input{../share/chap/WritingKatakana}       % Writing Katakana
\input{../share/chap/KatakanaTraining}      % Katakana Training
\input{../share/chap/Terminology}           % Terminology

\appendix

\input{../share/chap/AppendixKatakana}
\input{../share/chap/AppendixRomaji}
...
\normalsize
\phantomsection
\printindex{english}{English: Terms}\jsubindex{英語専門用語}
\phantomsection
\printindex{japanese}{Japanese: Index}\jsubindex{日本語専門用語}
\phantomsection
\printindex{german}{Deutsch: Fachbegriffe}\jsubindex{独逸語専門用語}
