...
\include{JTOPIC}% includes command \jtopic (hiragana, katakana, ...)
\include{JVERSION}
\include{JAUTHOR}
\include{JDATE}
\include{JDEDICATION}
...
\include{JNUMBER}
\include{JREVISION}
\include{JSCRIPT}% includes command \jscript (Hiragana, Katakana, ...)
\include{JTITLEJAPANESE}
\include{JSUBTITLEJAPANESE}
\include{JLANGUAGEJAPANESE}
\include{JTITLEORIGINAL}
\include{JSUBTITLEORIGINAL}
\include{JLANGUAGEORIGINAL}
