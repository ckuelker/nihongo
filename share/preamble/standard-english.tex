...
% 2022 (If new fonts are installed use them, otherwise old)
\IfFontExistsTF{YOzAb}{\setCJKfamilyfont{JapaneseFontA}{YOzAb}}{\setCJKfamilyfont{JapaneseFontA}{YOzFont90}}
\IfFontExistsTF{YOzC90b}{\setCJKfamilyfont{JapaneseFontB}{YOzC90b}}{\setCJKfamilyfont{JapaneseFontB}{YOzFontC90}}
\IfFontExistsTF{YOzE90b}{\setCJKfamilyfont{JapaneseFontC}{YOzE90b}}{\setCJKfamilyfont{JapaneseFontC}{YOzFontE90}}
...
% --- jterm (add list at Terminology.tex)% TODO: remove space before list
%          cntr          ext    title
\newlistof{jterminology}{jterm}{}% creates \listofjterminology
\newcommand{\jterm}[1]{%
%                    ext    cntr          content
    \addcontentsline{jterm}{jterminology}{\protect\numberline{} #1}%
}
...
\newcommand{\jquotesingleja}[1]{{「#1」}}    %「あ」
%\newcommand{\jquotesingleen}[1]{‘#1’}        % ‘…’ Font do not look good in SanSerif
\newcommand{\jquotesingleen}[1]{'#1'}        % '…'
%\newcommand{\jquotedoubleen}[1]{“#1”}        % “…” Font do not look good in SanSerif
\newcommand{\jquotedoubleen}[1]{"#1"}        % "…"
\newcommand{\jquotesinglede}[1]{‚#1‘}        % ‚…‘
\newcommand{\jquotedoublede}[1]{„#1“}        % „…“
\newcommand{\jquotefrenchsinglede}[1]{›#1‹}  % ›…‹
\newcommand{\jquotefrenchdoublede}[1]{»#1«}  % »…«
\newcommand{\jquotesingle}[1]{%
    \ifthenelse{\equal{ngerman}{\jlang}}{%
        \jquotesinglede{#1}
    }{%
        \jquotesingleen{#1}
    }%
}%
\newcommand{\jquotedouble}[1]{\ifthenelse{\equal{ngerman}{\jlang}}{\jquotedoublede{#1}}{\jquotedoubleen{#1}}}
