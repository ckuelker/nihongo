...
\KLETTER{a} The 片仮名 {「ア」} derives from the
...
\KLETTER{i} The 片仮名 {「イ」} derives from the
...
\KLETTER{u} The 片仮名 {「ウ」} derives from the
...
\KLETTER{e} The 片仮名 {「エ」} derives from the
...
\KLETTER{o} The 片仮名 {「オ」} derives from the
