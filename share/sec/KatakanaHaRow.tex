% ---------------------------------------------------------------------------
\section{ Katakana /ha/ Row}\jsec{片仮名ハ行}\label{sec:KatakanaHaRow}
...
% ---------------------------------------------------------------------------
\subsection{/fu/}\jsubsec{「フ」} \label{sec:KatakanaFu}
...
% ---------------------------------------------------------------------------
\subsection{/he/}\jsubsec{「ヘ」} \label{sec:KatakanaHe}
...
% ---------------------------------------------------------------------------
\subsection{/ho/}\jsubsec{「ホ」} \label{sec:KatakanaHo}
...
% ---------------------------------------------------------------------------
\subsection{/ha/ Row Training}\jsubsec{片仮名ハ行練習}\label{sec:HaRowTraining}
\Padding
