% ---------------------------------------------------------------------------
\section{Katakana /ka/ Row - 片仮名 カ行}\label{sec:KatakanaKaRow}
...
\hyperref[sec:PhoneticCharacter]{Phonetic Caracter}s upper part of {「己」}.  It is
...
% ---------------------------------------------------------------------------
\subsection{/ka/ - 「カ」} \label{sec:KatakanaKa}
...
% ---------------------------------------------------------------------------
\subsection{/ki/ - 「キ」} \label{sec:KatakanaKi}
...
% ---------------------------------------------------------------------------
\subsection{/ku/ - 「ク」} \label{sec:KatakanaKu}
% ---------------------------------------------------------------------------
...
% ---------------------------------------------------------------------------
\subsection{/ke/ - 「ケ」} \label{sec:KatakanaKe}
...
% ---------------------------------------------------------------------------
\subsection{/ko/ - 「コ」} \label{sec:KatakanaKo}
...
% ---------------------------------------------------------------------------
\subsection{/ka/ Row Training - 片仮名カ行練習}
