...
is easy to make a mistake. Make sure that you make all strokes long enough.}

\newpage

\KLETTER{ne} The  片仮名 {「ネ」} is pronounced  |ne| and  derives from the
...
\Note{Note}{Sorry again, the characters {「ノ」}, {「メ」} and {「ヌ」} are
similar and it is easy to make a mistake.} \newpage
