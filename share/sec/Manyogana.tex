% ---------------------------------------------------------------------------
\section{万葉仮名 - Manyogana} \label{sec:Manyogana}
...
\hyperref[sec:Kanji]{{漢字} {【かんじ】}} where use to pronounce the 90
\hyperref[sec:Mora]{morae}. This directly shows that there was no bijective map
between sound and character. For |ka| for example the following Manyogana can
be used {「可」}, {「何」}, {「加」}, {「架」}, {「香」}, {「蚊」}, {「迦」}. }

\Hint{Manyogana used for creation of {片仮名} {【かたかな】}}{
\begin{center}
