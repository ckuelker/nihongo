\section{Special Katakana Characters}\jsec{特別カタカナ}\label{sec:SpecialKatakanaCharacters}
...
\subsection{Doubling Vowels in Katakana}\jsubsec{カタカナでの倍増母音}\label{subsec:DoublingVowel}
