\section{Writing Katakana Letters}\jsec{片仮名を一つづつ書く} \label{sec:WritingKatakanaLetters}
...
%----------------------------------------------------------------------------
\subsection{Stroke Order Matter!}\jsubsec{書き順事項}\label{sec:StrokeOrderMatter}
